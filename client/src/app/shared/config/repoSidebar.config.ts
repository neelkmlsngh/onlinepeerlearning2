...
repoSidebar: {
	...
	HTML_MODE: "You have selected an html/css file , so u have to change yr mode to webdevelopment mode , click ok to continue",
	...
	NO_EXT:"Only HTML/CSS/JS files are allowed to edit in this codeeditor, press OK to just view the file",
