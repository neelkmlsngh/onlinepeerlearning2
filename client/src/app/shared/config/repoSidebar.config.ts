export const config: any = {
  ...
  repoSidebar: {
    ...
    HTML_MODE: "Would You Like to change your mode to Web Development Mode to access HTMl file",
    JAVASCRIPT_MODE: "Would You Like to change your mode to JAVASCRIPT Mode to access Javascript file",
