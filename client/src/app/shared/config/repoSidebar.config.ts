...
repoSidebar: {
	...
	HTML_MODE: "You are currently in Webeditor mode , You have clicked js file. To practise core JS click ok and your mode will be changed to js mode, else press cancel",
	JAVASCRIPT_MODE: "You have selected an html/css file , so u have to change yr mode to webdevelopment mode , click ok to continue",
