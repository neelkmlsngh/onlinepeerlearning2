export const config: any = {
  ...
  repoSidebar: {
    ...
    HTML_MODE: "Would You Like to change your mode to Web Development Mode to access HTMl/CSS file",
    JAVASCRIPT_MODE: "Press OK to change your mode to JAVASCRIPT Mode to practise Core JS",
